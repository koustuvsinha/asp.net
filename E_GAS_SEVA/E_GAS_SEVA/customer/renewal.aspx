<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="renewal.aspx.cs" Inherits="E_GAS_SEVA.view_subsidy" %>
        ...
        <div class="header">
            ...
            <div class="loginDispl">
                <asp:Label ID="user" runat="server" 
                    style="z-index: 1; left: 1121px; top: 22px; position: absolute; width: 236px; color: #FFFFFF;" 
...
<div class = "hide2">
				...
				<asp:Button ID="Button1" runat="server" 
                    style="z-index: 1; left: 524px; top: 255px; position: absolute; font-weight: 700;" 
                    Text="Renew Account" />
                <asp:Label ID="Label2" runat="server" 
                    style="z-index: 1; left: 379px; top: 206px; position: absolute; font-weight: 700; color: #003399;" 
                    Text="Account Valid Upto :"></asp:Label>
                <asp:TextBox ID="TextBox2" runat="server" ReadOnly="True" 
                    style="z-index: 1; left: 524px; top: 202px; position: absolute"></asp:TextBox>
                <asp:Label ID="Label1" runat="server" 
                    style="z-index: 1; left: 423px; top: 168px; position: absolute; font-weight: 700; color: #003399;" 
                    Text="Customer ID :"></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server" ReadOnly="True" 
                    style="z-index: 1; left: 524px; top: 164px; position: absolute"></asp:TextBox>
				</div>
				</form>

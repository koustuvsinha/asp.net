<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_complaints.aspx.cs" Inherits="E_GAS_SEVA.dealer.view_complaints" %>
...
<div class = "hide2">
				...
				<asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                    style="z-index: 1; left: 927px; top: 387px; position: absolute; font-weight: 700;" 
                    Text="Resolve" />
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    
                    style="z-index: 1; left: 363px; top: 197px; position: absolute; height: 77px; width: 516px" 
                    CellPadding="4" ForeColor="#333333" GridLines="None">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:TemplateField HeaderText="Complaint ID">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("complaint_id") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="complaint_type" HeaderText="Complaint Type" />
                        <asp:BoundField DataField="complaint_des" HeaderText="Complaint Description" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfer_request.aspx.cs" Inherits="E_GAS_SEVA.dealer.transfer_request" %>
...
<body>
    ...
    <div class="page">
        <div class="header">
            <div class="title">
                <h1>
                    E GAS SEva -transfer Request</h1>
            </div>
...
<div class = "hide2">
                <asp:Menu ID="Menu2" runat="server" CssClass="menu" EnableViewState="false" IncludeStyleBlock="false" Orientation="Vertical">
                    <Items>
                        ...
                        <asp:MenuItem Text="Transfer Request" Value="Transfer Request"></asp:MenuItem>
                ...
                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                    ...
                    style="z-index: 1; left: 1010px; top: 166px; position: absolute; font-weight: 700;" 
                    Text="Accept" />
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    
                    style="z-index: 1; left: 417px; top: 182px; position: absolute; height: 67px; width: 513px" 
                    CellPadding="4" ForeColor="#333333" GridLines="None">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:TemplateField HeaderText="Porting ID">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("porting_id") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("porting_id") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <asp:Label ID="Label3" runat="server" 
        ...
        style="z-index: 1; left: 416px; top: 132px; position: absolute; font-weight: 700; color: #0000CC;"></asp:Label>
    </form>
</body>
</html>

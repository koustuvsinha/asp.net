<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="refill.aspx.cs" Inherits="E_GAS_SEVA.refill" %>
...
<body>
    ...
    <div class="page">
        <div class="header">
            <div class="title">
                <h1>
                    E GAS SEva&nbsp; -&nbsp; dealer order requests</h1>
            </div>
...
<div class = "hide2">
                ...
                <asp:Button ID="Button1" runat="server" 
                    style="z-index: 1; left: 948px; top: 353px; position: absolute; font-weight: 700;" 
                    Text="Accept" onclick="Button1_Click" />
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    
                    
                    style="z-index: 1; left: 425px; top: 185px; position: absolute; height: 18px; width: 513px" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Dealer ID">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("dealer_id") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("dealer_id") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Order Qty">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("order_qty") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("order_qty") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assign_cylinder.aspx.cs" Inherits="E_GAS_SEVA.assign_cylinder" %>
...
<div class = "hide2">
                ...
                <asp:Label ID="Label3" runat="server" 
                    ...
                    style="z-index: 1; left: 762px; top: 168px; position: absolute; font-weight: 700;"></asp:Label>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    onrowcancelingedit="GridView1_RowCancelingEdit" 
                    onrowediting="GridView1_RowEditing" onrowupdating="GridView1_RowUpdating" 
                    
                    style="z-index: 1; left: 352px; top: 257px; position: absolute; height: 111px; width: 600px" 
                    CellPadding="4" ForeColor="#333333" GridLines="None">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:TemplateField HeaderText="Dealer ID">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("dealer_id") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("dealer_id") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Stock No">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("stock_no") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("stock_no") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:CommandField HeaderText="Update Stock" ShowEditButton="True" />
                    </Columns>
                ...
                <asp:Label ID="Label2" runat="server" 
                    style="z-index: 1; left: 453px; top: 191px; position: absolute; font-weight: 700; color: #0000CC;" 
                    Text="Select City :"></asp:Label>
                <asp:Label ID="Label1" runat="server" 
                    style="z-index: 1; left: 448px; top: 154px; position: absolute; margin-bottom: 0px; font-weight: 700; color: #0000CC;" 
                    Text="Select State :"></asp:Label>
                <asp:DropDownList ID="DropDownList2" runat="server" 
                    style="z-index: 1; left: 540px; top: 188px; position: absolute" 
                    AutoPostBack="True" onselectedindexchanged="DropDownList2_SelectedIndexChanged">
                    <asp:ListItem>Select</asp:ListItem>
                </asp:DropDownList>
                <asp:DropDownList ID="DropDownList1" runat="server" 
                    style="z-index: 1; left: 539px; top: 152px; position: absolute" 

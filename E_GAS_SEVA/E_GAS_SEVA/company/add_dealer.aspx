<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_dealer.aspx.cs" Inherits="E_GAS_SEVA.company.add_dealer" %>
...
<div class = "hide2">
                ...
                <asp:Button ID="Button2" runat="server" 
                    style="z-index: 1; left: 1107px; top: 276px; position: absolute" 
                    Text="Refresh" />
                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                    style="z-index: 1; left: 1027px; top: 276px; position: absolute" 
                    Text="Accept" />
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    
                    style="z-index: 1; left: 390px; top: 205px; position: absolute; height: 108px; width: 548px" 
                    CellPadding="4" ForeColor="#333333" GridLines="None">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:TemplateField HeaderText="Dealer ID">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("dealer_id") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>

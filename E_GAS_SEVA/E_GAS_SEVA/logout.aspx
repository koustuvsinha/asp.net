<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="logout.aspx.cs" Inherits="E_GAS_SEVA.logout" %>
...
<body>
    ...
    <div class="page">
        ...
        style="z-index: 1; left: 377px; top: 208px; position: absolute; height: 24px; width: 328px; font-weight: 700; text-decoration: underline; color: #003399; font-size: large; font-family: 'Segoe UI';" 
        Text="You have been sucessfully logged out!"></asp:Label>
        </form>
</body>
</html>
